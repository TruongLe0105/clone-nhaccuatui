...
const DiscoverGeneral = ({ list, fullOptions, isVideo, classCard }: any) => {
        ...
        return (
            ...
            >
                {data.map((item: any, index: number) => (
                    <div key={index} className='flex flex-col' style={{ width: isVideo ? '32%' : '23%', marginBottom: '1rem' }}>
                        <CardItemMain
                            key={index}
                            item={item}
                            classCard={classCard}
...
export default DiscoverGeneral;